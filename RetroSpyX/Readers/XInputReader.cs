...
namespace RetroSpy.Readers
{
    public sealed class XInputReader : IControllerReader
    {
        ...
        private void Tick(object? sender, EventArgs e)
        {
            ...
            vJoyInterface.SetButton(1, ((int)state.Gamepad.Buttons & 0x1000) != 0);
            outState.SetButton("b", ((int)state.Gamepad.Buttons & 0x2000) != 0);
            vJoyInterface.SetButton(2, ((int)state.Gamepad.Buttons & 0x2000) != 0);
            outState.SetButton("x", ((int)state.Gamepad.Buttons & 0x4000) != 0);
            vJoyInterface.SetButton(4, ((int)state.Gamepad.Buttons & 0x4000) != 0);
            ...
            vJoyInterface.SetButton(11, ((int)state.Gamepad.Buttons & 0x0001) != 0);
            outState.SetButton("down", ((int)state.Gamepad.Buttons & 0x0002) != 0);
            vJoyInterface.SetButton(12, ((int)state.Gamepad.Buttons & 0x0002) != 0);
            outState.SetButton("left", ((int)state.Gamepad.Buttons & 0x0004) != 0);
            vJoyInterface.SetButton(13, ((int)state.Gamepad.Buttons & 0x0004) != 0);
            outState.SetButton("right", ((int)state.Gamepad.Buttons & 0x0008) != 0);
            vJoyInterface.SetButton(14, ((int)state.Gamepad.Buttons & 0x0008) != 0);

            outState.SetButton("start", ((int)state.Gamepad.Buttons & 0x0010) != 0);
            vJoyInterface.SetButton(8, ((int)state.Gamepad.Buttons & 0x0010) != 0);
            outState.SetButton("back", ((int)state.Gamepad.Buttons & 0x0020) != 0);
            vJoyInterface.SetButton(7, ((int)state.Gamepad.Buttons & 0x0020) != 0);
            outState.SetButton("l3", ((int)state.Gamepad.Buttons & 0x0040) != 0);
            vJoyInterface.SetButton(9, ((int)state.Gamepad.Buttons & 0x0040) != 0);
            outState.SetButton("r3", ((int)state.Gamepad.Buttons & 0x0080) != 0);
            vJoyInterface.SetButton(10, ((int)state.Gamepad.Buttons & 0x0080) != 0);
            ...
            vJoyInterface.SetAxis(vJoyAxis.XR, (float)state.Gamepad.RightThumbX / 32768);
            outState.SetAnalog("rstick_y", (float)state.Gamepad.RightThumbY / 32768, state.Gamepad.RightThumbY);
            vJoyInterface.SetAxis(vJoyAxis.YR, (float)state.Gamepad.RightThumbY / 32768);
            outState.SetAnalog("trig_l", (float)state.Gamepad.LeftTrigger / 255, state.Gamepad.LeftTrigger);
            vJoyInterface.SetAxis(vJoyAxis.SL0, (float)state.Gamepad.LeftTrigger / 255);
            ...
            vJoyInterface.SetAxis(vJoyAxis.SL1, (float)state.Gamepad.RightTrigger / 255);
